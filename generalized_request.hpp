...
(echo "#include<"$0">" > $0x.cpp) && mpicxx -O3 -std=c++14 -Wall `#-Wfatal-errors` -D_TEST_BOOST_MPI3_GENERALIZED_REQUEST $0x.cpp -o $0x.x && time mpirun -np 4 $0x.x $@ && rm -f $0x.x $0x.cpp; exit
#endif
