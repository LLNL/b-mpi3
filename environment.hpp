...
thread_level initialize(int& argc, char**& argv, thread_level required){
...
class environment : environment_base{
	...
	communicator& world() const{return boost::mpi3::communicator::world;}
	communicator& self() const{return boost::mpi3::communicator::self;}
